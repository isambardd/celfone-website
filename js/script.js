jQuery(function($){
    ...
    /* The code doesn't work with the line below is uncommented*/
	//Elements Animationif ( $('.our-client').length) {



    /* Start - this section makes all of the code appear in a cool way on the screen */
    ...
    /* End - this section makes all of the code appear in a cool way on the screen*/




	
	/* Start - Animate Progess bar
	=========================== */
